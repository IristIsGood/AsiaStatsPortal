...
A full-stack statistical data portal that built with PHP/Laravel 11 and Vue 3, featuring a public REST API that supports multiple output formats, role-based access control, and a data validation workflow.
